...
import RentalFormOnlyDriver from '../../../components/RentalFormOnlyDriver';

export default function OnlyDriverScreen() {
  ...
  return (
    <ImageBackground 
      source={require('../../../../assets/onlyDriver.jpg')}
