...
import RentalFormSelfDriver from '../../../components/RentalFormSelfDriver';

export default function SelfDriverScreen() {
  ...
  return (
    <ImageBackground 
      source={require('../../../../assets/image/selfDriver.jpg')}
