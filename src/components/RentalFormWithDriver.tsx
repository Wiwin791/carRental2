...
export default function RentalFormWithDriver({ onSearch }: RentalFormProps) {
  ...
  return (
    <View style={styles.formCard}>
      <Text style={styles.formTitle}>With Driver</Text>
      ...
      {/* Pickup Date */}
      <TouchableOpacity style={styles.inputGroup} onPress={showDatePickerHandler}>
      ...
      <View style={styles.inputGroup}>
        ...
        <Text style={styles.inputText}>{days} day{days > 1 ? 's' : ''}</Text>
